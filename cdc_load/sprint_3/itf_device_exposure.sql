...
DROP TABLE if exists itfcdmpv532_daily.ITF_DEVICE_EXPOSURE;;


CREATE TABLE itfcdmpv532_daily.ITF_DEVICE_EXPOSURE as
...
from ( 
    ...
    from (
        SELECT
            ...
            ,order_cnt  ::  int
            ,order_day  ::  int
            ,A.order_dr    ::  varchar(50) AS order_dr
...
select (SELECT last_value FROM etl_task_check_grp_id), 'itf_device_exposure' , 'itf_device_exposure', count(*) as cnt
from itfcdmpv532_daily.itf_device_exposure ;
