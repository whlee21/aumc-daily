/*****************************************************
프로그램명  : itf_procedure_occurrence .sql
작성자      : Won Jong Bok
수정자      :
최초 작성일 : 2020-12-07
수정일      :
...
DROP TABLE if exists itfcdmpv532_daily.itf_procedure_occurrence ;;


CREATE  TABLE itfcdmpv532_daily.itf_procedure_occurrence  as
...
select (SELECT last_value FROM etl_task_check_grp_id), 'itf_procedure_occurrence' , 'itf_procedure_occurrence', count(*) as cnt
from itfcdmpv532_daily.itf_procedure_occurrence ;
